...
namespace Elements.IFC
{
    public static partial class IFCExtensions
    {
        ...
        private static Floor ToFloor(this IfcSlab slab, IEnumerable<IfcOpeningElement> openings)
        {
            ...
            var solidTransform = solid.Position.ToTransform();
            var floor = new Floor(new Profile(outline), (IfcLengthMeasure)solid.Depth, solidTransform, solid.ExtrudedDirection.ToVector3(), 
                0, transform, new Material("slab",Colors.Green));
