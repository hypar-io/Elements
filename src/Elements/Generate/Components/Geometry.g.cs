...
namespace Elements.Components
{
    ...
    /// <summary>A geometry component comprised of one or more geometries.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.24.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class Geometry : Component
    {
        ...
        public System.Collections.Generic.ICollection<Solid> Geometries { get; set; } = new System.Collections.ObjectModel.Collection<Solid>();
