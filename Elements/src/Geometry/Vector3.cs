...
namespace Elements.Geometry
{
    ...
    public partial struct Vector3 : IComparable<Vector3>, IEquatable<Vector3>
    {
        ...
        /// <summary>
        /// Is the vector horizontal within epsilon?
        /// The vector will be unitized before evaluation.
        /// </summary>
        /// <returns>True if the vector is horizontal, otherwise false.</returns>
        public bool IsHorizontal()
        {
            return Math.Abs(this.Unitized().Z) < Vector3.EPSILON;
        }

        /// <summary>
        /// Is the vector vertical within epsilon?
        /// The vector will be unitized before evaluation.
        /// </summary>
        /// <returns>True if the vector is vertical, otherwise false.</returns>
        public bool IsVertical()
        {
            return Math.Abs(this.Unitized().Z) - 1.0 < Vector3.EPSILON;
        }
