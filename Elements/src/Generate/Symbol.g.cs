...
namespace Elements
{
    ...
    public partial class Symbol : Element
    {
        [Newtonsoft.Json.JsonConstructor]
        public Symbol(GeometryReference @geometry, SymbolCameraPosition @cameraPosition, System.Guid @id = default, string @name = null)
            : base(id, name)
        {
            var validator = Validator.Instance.GetFirstValidatorForType<Symbol>();
            if(validator != null)
            {
                validator.PreConstruct(new object[]{ @geometry, @cameraPosition, @id, @name});
            }
