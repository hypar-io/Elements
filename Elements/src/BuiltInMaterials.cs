...
namespace Elements
{
    ...
    public static class BuiltInMaterials
    {
        ...
        private static Material _analysis = new Material($"analysis", Colors.White, 0, 0, null, true, true, Guid.Parse("5b1872e7-726e-4e4a-9b7c-cc38339d25b0"));
        ...
        /// <summary>
        /// A white material with no glossiness or specularity, for
        /// use with meshes that have vertex coloration.
        /// </summary>
        public static Material Analysis => _analysis;
    }
}