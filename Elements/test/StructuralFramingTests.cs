...
namespace Elements.Tests
{
    public class StructuralFramingTests : ModelTest
    {
        ...
        public void Beam(string testName, BeamType beamType, double startSetback, double endSetback)
        {
            ...
            Assert.Equal(BuiltInMaterials.Steel, beam.FirstRepresentationOfType<SolidRepresentation>().Material);
        ...
        public void Column()
        {
            ...
            Assert.Equal(BuiltInMaterials.Steel, column.FirstRepresentationOfType<SolidRepresentation>().Material);
        ...
        public void Brace()
        {
            ...
            Assert.Equal(BuiltInMaterials.Steel, brace.FirstRepresentationOfType<SolidRepresentation>().Material);
        ...
        public void Benchmark()
        {
            ...
            for (var i = 0; i < n; i++)
            {
                ...
                var rep = beam.FirstRepresentationOfType<SolidRepresentation>();
