...
namespace Elements.Tests
{
    public class TopographyTests : ModelTest
    {
        ...
        public void Csg()
        {
            ...
            csg = csg.Subtract(box._csg.Transform(new Transform(topo.Mesh.Vertices[topo.RowWidth * topo.RowWidth / 2 + topo.RowWidth / 2].Position + new Vector3(0, 0, -50)).ToMatrix4x4()));
