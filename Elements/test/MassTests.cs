...
namespace Elements.Tests
{
    public class MassTests : ModelTest
    {
        ...
        public void Update()
        {
            ...
            var t = new Vector3(5, 0, 0);
            this.Model.AddElement(mass);
            Assert.True(Model.Elements.ContainsKey(profile.Id));

            // Change the geometry of the profile and 
            // ensure that the representation's profile matches
            // and the model contains the profile.
