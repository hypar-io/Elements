...
namespace Elements.Geometry.Tests
{
    public class PolygonTests : ModelTest
    {
        ...
        public void AreaCentroids()
        {
            ...
            var pgon2 = new Polygon((54.53824, 29.174668, -13.957174),
            ...
            Assert.True(pgon2.Centroid().IsAlmostEqualTo(new Vector3(32.623945, 23.645959, 3.564879)));

            var pgon3 = new Polygon((10.072801, 0.604668, 31.063089),
            ...
            Assert.True(pgon3.Centroid().IsAlmostEqualTo(new Vector3(11.681926, 11.801531, 12.813532)));

            var pgon4 = new Polygon((38.337892, 0.04147, 27.352492),
            (55.553043, 1.557338, 17.913199),
