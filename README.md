...
# Configuration
A `hypar.json` file, located at the root of the repository, is used to provide information about the function to Hypar. Here's an example of a `hypar.json` file.
```json
{
  "function": "box.box",
  "runtime": "python3.6",
