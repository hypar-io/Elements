...
#pragma warning disable // Disable all warnings
    ...
    {
        [JsonConstructor]
        public PressureCalculationSegment(double @diameter, double @diameterInner, double @flow, double @heightDelta, double @length, double @pipeLoss, double @staticGain, double @frictionFactor, double @reynoldsNumber, double @fluidVelocity, double @dynamicPressure, double @maxUnderPressure, double @totalPressure, double @frictionLossCoefficient, System.Guid @elementId)
            : base(elementId)
        {
