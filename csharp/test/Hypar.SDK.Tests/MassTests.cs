...
namespace Hypar.Tests
{
    public class MassTests
    {
        ...
        public void Construct()
        {
            ...
            var mass = new Mass(profile, 0, 40);
            model.AddElement(mass);
        ...
        public void Transformed_Masses()
        {
            ...
            var mass2 = new Mass(profile2, 10.0, 20.0, material2);
            var mass3 = new Mass(profile3, 20.0, 30.0, material3);
        ...
        public void Volume()
        {
            var profile = Profiles.Rectangular(Vector3.Origin, 5, 5);
