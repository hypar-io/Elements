...
namespace Elements.Geometry.Tests
{
    public class PolylineTests
    {
        ...
        public void Polyline_ClosedOffset()
        {
            ...
            // offsets to a rectangle that's offsetAmt longer than the segment, and 2x 
            // offsetAmt in width, so the long sides are each length + 2x offsetAmt,
            // and the short sides are each 2x offsetAmt.
