...
zip -r hypar-linux-x64.zip -j ./src/cli/bin/Release/netcoreapp2.1/linux-x64/publish &&
zip -r hypar-osx.10.12-x64.zip -j ./src/cli/bin/Release/netcoreapp2.1/osx.10.12-x64/publish &&
zip -r hypar-win-x64.zip -j ./src/cli/bin/Release/netcoreapp2.1/win-x64/publish &&
