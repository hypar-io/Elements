...
namespace Elements.IFC.Tests
{
    public class IfcTests
    {
        ...
        public void Doors()
        {
            ...
            var door1 = new Door(wallLine1, 0.5, 1.5, Door.DOOR_DEFAULT_THICKNESS, 2.0, DoorOpeningSide.LeftHand, DoorOpeningType.DoubleSwing);
            var door2 = new Door(wallLine2, 0.5, 1.5, Door.DOOR_DEFAULT_THICKNESS, 1.8, DoorOpeningSide.LeftHand, DoorOpeningType.DoubleSwing);
